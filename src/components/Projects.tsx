...
const projects = [
  ...
  { tag: 'Banheiro master',   title: 'Revestimento contínuo em Taj Mahal',       city: 'Goiânia · GO',     tone: 'from-[#eef0ec] to-[#a4b0a6]' },
  { tag: 'Lareira',           title: 'Volume escultural em Ônix retroiluminado', city: 'Anápolis · GO',    tone: 'from-[#3a2616] to-[#1a0f06]' },
  { tag: 'Hall comercial',    title: 'Piso paginado em Travertino Romano',       city: 'Caldas Novas · GO', tone: 'from-[#ead9ba] to-[#a0825b]' },
  { tag: 'Spa & piscina',     title: 'Borda em quartzito Patagonia escovado',    city: 'Pirenópolis · GO', tone: 'from-[#e2e7e8] to-[#7c8e94]' },
  { tag: 'Banheiro',          title: 'Lavatório esculpido em Mármore Branco Siena', city: 'Goiânia · GO', tone: 'from-[#f1ead7] to-[#a99a78]' },
  { tag: 'Fachada',           title: 'Revestimento ventilado em Dekton',         city: 'Brasília · DF',    tone: 'from-[#373735] to-[#15151a]' },
];
